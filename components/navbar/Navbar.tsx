            ...
            <div className="w-full mx-auto  py-1">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex space-x-8 tracking-normal text-stone-800">
                        {activeRole == 'teacher' ? (
                            <Link href="/jobs" className="mr-20 py-2 my-auto px-5 bg-blue-700 rounded text-white">Find
                                Jobs</Link>
                        ) : (
                        ...
                        {loggedIn ? (
                            <>
                                ...
                                <a className="my-auto"><MdOutlineLocalGroceryStore className="text-stone-700"
                                                                                   size={22}/></a>
                            ...
                            <>
                                <Link href="/auth/login"
                                      className="rounded border-1 border-gray-300 mr-5 px-7 py-3 bg-white text-sm">Login</Link>
